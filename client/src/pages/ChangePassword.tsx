...
export default function ChangePassword() {
  ...
  const { forceChangePassword, error, clearError, user } = useAuthStore();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (newPassword === 'Ngr@123') {
      setLocalError('A nova senha não pode ser igual à senha padrão');
      return;
    }
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-100 to-blue-50">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-amber-500 rounded-2xl shadow-xl mb-4">
            <ShieldCheck className="w-10 h-10 text-white" />
          </div>
          <h1 className="text-2xl font-bold text-ngr-primary mb-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                ...
                <br />
                • Não pode ser igual à senha padrão (Ngr@123)
              </p>
            </div>
